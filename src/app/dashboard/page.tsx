    ...
    <div className="flex h-screen bg-gray-100">
      ...
      <aside className="fixed left-0 top-0 bottom-0 w-64 bg-white border-r border-gray-200 flex flex-col z-10">
        ...
        <nav className="flex-1 overflow-y-auto p-6">
          <button className="w-full bg-purple-500 text-white rounded-md py-3 px-6 flex items-center justify-center gap-3 mb-8 text-lg">
            <Plus className="w-6 h-6" />
            Create post
          </button>
          <div className="mb-8">
            <h2 className="text-sm font-semibold text-gray-500 mb-4">Content</h2>
            <ul className="space-y-3">
              <li>
                <Link href="#" className="flex items-center gap-4 text-gray-700 py-3 px-4 rounded-md hover:bg-gray-100 text-lg">
          ...
          <div>
            <h2 className="text-sm font-semibold text-gray-500 mb-4">Configuration</h2>
            <ul className="space-y-3">
              <li>
                <Link href="#" className="flex items-center gap-4 text-gray-700 py-3 px-4 rounded-md hover:bg-gray-100 text-lg">
      ...
      <div className=" bg-white rounded-full shadow-md p-4">
        ...
        <div className="p-6 border-t border-gray-200">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-full bg-gray-300 flex items-center justify-center text-xl font-medium text-gray-600">
              N
            </div>
            <div>
