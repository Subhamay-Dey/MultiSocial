    ...
    <div className="flex h-screen bg-gray-100">
      ...
      <div className=" bg-white rounded-full flex flex-col gap-3 p-4">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-medium bg-gradient-to-b from-gray-900 via-black to-gray-600 bg-clip-text text-transparent">5 posts left</span>
        </div>
        ...
        <div className="p-4 border-t border-gray-200">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-medium bg-gradient-to-b from-gray-900 via-black to-gray-600 bg-clip-text text-transparent">{session?.user.name}</p>
